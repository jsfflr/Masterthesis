...
%    SET LANGUAGE       %
%%%%%%%%%%%%%%%%%%%%%%%%%
\def\lang{english} % Options: english or ngerman
...
\author{Julian Scheffler}
\thesis{Master Thesis}
\title{Integration of an API Gateway to Decouple a Client-Server Architecture: Enhancing Maintainability and Expandability}
\academicTitle{Master of Science}
\firstReferee{Prof. Dr. Dennis Priefer}
\secondReferee{Andrej Sajenko}
